...
void ui_event_back4(lv_event_t *e) // back on ChatGPT
{
    lv_event_code_t event_code = lv_event_get_code(e);
    lv_obj_t *target = lv_event_get_target(e);
...
/**********************  openai  **********************/
// 注意是数据要显示的部分才在这里添加事件(其可能有多个事件)
/**
 * @brief
 * 1.
 */
// static void __openai_event_init(void)
// {
//     lv_obj_add_event_cb(ui_openai, ui_event_openai, LV_EVENT_ALL, NULL);
// }
